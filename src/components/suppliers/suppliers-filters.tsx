...
export function SuppliersFilters() {
  ...
  // Categories, Loading Points, Delivery Types, Reject Reasons, and
  // Material Models use so the pages can't drift on "how debounced search
  // feels" — see material-pc-filters.tsx for the original.
  React.useEffect(() => {
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="relative w-full sm:max-w-xs">
        ...
        <label htmlFor="supplier-search" className="sr-only">
          ค้นหาผู้จัดจำหน่ายด้วยรหัสหรือชื่อ
        </label>
        <Input
          id="supplier-search"
          value={search}
