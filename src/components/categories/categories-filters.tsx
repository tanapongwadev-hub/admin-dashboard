...
export function CategoriesFilters() {
  ...
  // value into the URL. Mirrors the same pattern Materials PC and Products
  // use so the three pages can't drift on "how debounced search feels" —
  // see material-pc-filters.tsx for the original.
  React.useEffect(() => {
